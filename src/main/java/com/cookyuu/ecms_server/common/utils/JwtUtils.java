...
public class JwtUtils {
    ...
    public void isLogoutToken(Long memberId, String accessToken) {
        ...
        try {
            ...
            throw new AuthenticationException(ResultCode.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public void validateToken(String token) {
        try {
            ...
            throw new AuthenticationException(ResultCode.JWT_SECURE_EXP);
        } catch (MalformedJwtException e) {
            log.info("[ValidateJwtToken] Invalid JWT Token. ", e);
            throw new AuthenticationException(ResultCode.JWT_INVALID_TOKEN);
        } catch (ExpiredJwtException e) {
            ...
            throw new AuthenticationException(ResultCode.JWT_UNSUPPORTED_TOKEN);
        } catch (IllegalArgumentException e) {
            log.info("[ValidateJwtToken] JWT Claims String is empty. ", e);
            throw new AuthenticationException(ResultCode.JWT_EMPTY_TOKEN);
        } catch (Exception e) {
            throw new AuthenticationException(ResultCode.INTERNAL_SERVER_ERROR);
        }
    }
