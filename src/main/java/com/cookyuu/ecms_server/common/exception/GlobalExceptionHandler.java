...
//    private final SlackService slackService;
    ...
    public ResponseEntity<ApiResponse<Object>> handleBusinessException(WebRequest request, BusinessException e) {
    ...
    public ResponseEntity<ApiResponse<Object>> handleAuthenticationException(WebRequest request, AuthenticationException e) {
        String errMsg = e.getMessage() != null ? e.getMessage() : e.getResultCode().getMessage();
    ...
    public ResponseEntity<ApiResponse<Object>> handleExternalApiException(WebRequest request, ExternalApiException e) {
